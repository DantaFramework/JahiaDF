...
public class Constants {
    ...
    public static final String LX_EXT = layerx.Constants.DOT + LX;

    // LayerX Configuration Global Properties and Page Properties
    ...
    public static final String LAYERX_CONFIGURATION_PAGE_PATH_PROPERTY = "layerxPagePath";
    public static final String LAYERX_CONFIGURATION_SITE_SUFFIX_PATH = "contents";
    public static final String LAYERX_CONFIGURATION_NODE_NAME = "layerx";
