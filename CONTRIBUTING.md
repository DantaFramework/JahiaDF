...
* If you find solution to an [issue/improvements](https://github.com/DataFramework/JahiaDF/issues) in sdk that would be helpful to everyone, feel free to send us a pull request.
