...
import static layerx.jahia.util.PropertyUtils.propsToMap;

import static layerx.jahia.Constants.RESERVED_SYSTEM_NAME_PREFIXES;
            ...
            if (resource != null && renderContext != null) {
                if (!contentModel.has(PAGE_PROPERTIES_KEY)) {
                    ...
                    if (mainResource != null) {
                        ...
                        // Set LayerX configuration for page resources only as it is obtained via the template
                        ...
                        // Load Page Properties From LayerX Functionality BEGIN ****************************************
                        ...
                        if (jcrSession.nodeExists(layerXConfigurationNode)) {
                            ...
                            if (layerXNode != null && layerXNode.hasNode(LAYERX_CONFIGURATION_PAGE_NODE_NAME)) {
                                ...
                                LOG.error("LayerX Configuration PageStructure Not found: " + layerXConfigurationNode + " For resource: " + mainResource.getPath());
                            }
                        }else{
                            LOG.error("LayerX Configuration Structure Not found: " + layerXConfigurationNode + " For resource: " + mainResource.getPath());
                        }

                        // Load Page Properties From LayerX Functionality END ******************************************
