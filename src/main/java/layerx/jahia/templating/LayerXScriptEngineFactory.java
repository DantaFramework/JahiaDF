...
import layerx.jahia.configuration.JahiaConfigurationProviderImpl;
 ...
 */
@Component(
        label = "Xumak Scripting LayerX",
        description = "Xumak Scripting engine for LayerX",
        immediate = true,
        metatype = true
)
...
public class LayerXScriptEngineFactory implements ScriptEngineFactory {

    private static Logger LOG = LoggerFactory.getLogger(LayerXScriptEngineFactory.class);
    ...
    private final static List<String> names = Collections.singletonList("layerx");
    ...
    protected void activate(BundleContext bundleContext)
        ...
        LOG.info(LOG_PRE + "======= LayerXScriptEngineFactory Activate  ==========");
    ...
    protected void deactivate(BundleContext bundleContext){
        LOG.info(LOG_PRE + "======= LayerXScriptEngineFactory Deactivate  ==========");
    }
    ...
    public ScriptEngine getScriptEngine() {
        ...
        return new LayerXScriptEngine(this, contextProcessorEngineStatic, configurationProviderStatic, domProcessorEngineStatic, helperFunctionBindStatic);
    }
